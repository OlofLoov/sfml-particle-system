...
execute_process(
  COMMAND "/usr/bin/git" show-ref "2f11710abc5aa478503a7ff3f9e654bd2078ebab"
  WORKING_DIRECTORY "/Users/olofloov/Projects/sfml-particle-system/build/_deps/sfml-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "2f11710abc5aa478503a7ff3f9e654bd2078ebab")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("2f11710abc5aa478503a7ff3f9e654bd2078ebab" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/2f11710abc5aa478503a7ff3f9e654bd2078ebab")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/olofloov/Projects/sfml-particle-system/build/_deps/sfml-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/olofloov/Projects/sfml-particle-system/build/_deps/sfml-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
